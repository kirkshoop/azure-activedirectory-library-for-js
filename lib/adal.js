...
var AuthenticationContext = (function () {
     ...
     *  @property {Boolean} multiFactor - Support multi-factor login.
     *  @property {string} resource - Set this, when supporting multi-factor login, to associate the resource that will be used with acquireToken.
     */
    ...
    AuthenticationContext.prototype.login = function () {
        ...
        var resource = null;
        // if it is required user should be authenticated through multi-factor authentication flow.
        if (this.multiFactor) {
            responseType = 'code+' + responseType;
            resource = this.config.resource;
        }

        var urlNavigate = this._getNavigateUrl(responseType, resource) + '&nonce=' + encodeURIComponent(this._idTokenNonce);
